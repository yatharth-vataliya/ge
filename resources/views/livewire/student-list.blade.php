    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 p-2 m-2 rounded bg-white shadow">
                ...
                <input type="text" class="form-control" name="search" wire:model.live="search"
                    placeholder="Search by name,contact,enrollment no,email">
            </div>
                        ...
                        @foreach ($students as $student)
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-danger"
                                        onclick="remove_registration({{ $student->id }});">Delete</button></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
