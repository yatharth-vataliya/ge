                    ...
                    <tbody>
                        @foreach ($courses as $course)
                            <tr id="row{{ $course->id }}">
                                ...
                                <td><a href="{{ route('edit_course', ['course_id' => $course->id]) }}"
                                        class="btn btn-warning">Edit</a></td>
                                <td><button type="button" class="btn btn-danger"
                                        onclick="delete_course({{ $course->id }});">Delete</button></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
