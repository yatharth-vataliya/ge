					...
					<form method="POST" action="{{ route('update_department') }}">
						...
						<div class="form-group">
							...
							<select name="institute_id" id="institute" class="custom-select">
								...
								<option value="{{ $institute->id }}" selected>{{ $institute->institute_name }}</option>
								@endif
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="department_name" placeholder="Department Name" value="{{ $department->department_name }}">
						</div>
						<div class="form-inline form-group">	
							<div class="form-check form-check-inline">
								TYPE :- &nbsp;
								<input type="radio" name="type" id="PG" value="PG" class="form-check-input" {{ $department->type == 'PG' ? 'checked' : '' }}>
								<label for="PG" class="form-check-label">PG</label>
							</div>
							<div class="form-check form-check-inline">
								<input type="radio" name="type" class="form-check-input" value="UG" id="UG" {{ $department->type == 'UG' ? 'checked' : '' }}>
