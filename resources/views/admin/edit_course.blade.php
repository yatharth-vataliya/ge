					...
					<form method="POST" action="{{ route('update_course') }}" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<select name="department_id" id="department" class="custom-select">
								...
								<option value="{{ $department->id }}" selected>{{ $department->department_name }} ({{ $department->type }})</option>
								@endif
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="course_code" id="course_code" placeholder="Course Code" value="{{ $course->course_code }}">
						</div>
						<div class="form-group">
							<label for="course_limit">Course Limit</label>
							<input type="text" class="form-control" name="course_limit" id="course_limit" placeholder="Course Limit" value="{{ $course->course_limit }}">
						</div>
						<div class="form-group">
