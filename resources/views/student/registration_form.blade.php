                    ...
                    <div class="card border-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="institute_id" class="custom-select" id="institute"
                                    onchange="load_department(this.value);">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="degree" name="degree" value="UG" class="custom-radio"
                                    onchange="load_department(document.querySelector('#institute').value)" checked="">
                                UG
                                <input type="radio" id="degree" name="degree" value="PG" class="custom-radio"
                                    onchange="load_department(document.querySelector('#institute').value)"> PG
                            </div>
                            <div class="form-group">
                                <label for="department">Select Department</label>
                                <select name="department_id" class="custom-select" id="department"
                                    onchange="load_program(this.value);load_course(this.value);">
                            ...
                            <div class="form-group">
                                ...
                                <select name="sem" class="custom-select">
                                    <option value="{{ old('sem') ?? '' }}" selected>{{ old('sem') ?? 'Select Sem' }}
                                    </option>
